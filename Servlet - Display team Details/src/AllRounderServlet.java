...
/**
 * Servlet implementation class AllRounderServlet
 */
@WebServlet("/AllRounderServlet")
public class AllRounderServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AllRounderServlet() {
        super();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String ht="<html><head></head><body>"
		    		...
		    		+ "<h4>All Rounder Details</h4>"
		    		+ "<table id='all_rounder' border=1>"
